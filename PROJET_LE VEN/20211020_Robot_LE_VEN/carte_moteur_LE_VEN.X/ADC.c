...
ANSELCbits.ANSC0 = 1;//1 droit
ANSELCbits.ANSC11 = 1;//2 milieu
ANSELGbits.ANSG9 = 1;//4 gauche

//3(B1)-15(E15)
ANSELBbits.ANSB1 = 1; //0 extreme droit
ANSELEbits.ANSE15 = 1;//3 extreme gauche
...
ADCResult[3] = ADC1BUF3;// Capteurs supplémentaires
